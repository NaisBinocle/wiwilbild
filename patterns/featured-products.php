...
<div class="wp-block-group alignfull has-surface-background-color has-background" style="padding-top:var(--wp--preset--spacing--70);padding-right:var(--wp--preset--spacing--70);padding-bottom:var(--wp--preset--spacing--70);padding-left:var(--wp--preset--spacing--70)">
	...
	<div class="wp-block-group" style="margin-bottom:var(--wp--preset--spacing--50)">
		...
		<p class="has-text-align-center has-primary-color has-text-color" style="font-size:12px;font-weight:700;letter-spacing:2px;text-transform:uppercase">Bestsellers</p>
		<!-- /wp:paragraph -->

		<!-- wp:heading {"textAlign":"center","level":2} -->
		<h2 class="wp-block-heading has-text-align-center">Ce que choisissent nos clients en ce moment</h2>
		<!-- /wp:heading -->

		<!-- wp:paragraph {"align":"center","textColor":"body"} -->
		<p class="has-text-align-center has-body-color has-text-color">Les produits les plus plébiscités par nos clients particuliers et professionnels.</p>
		<!-- /wp:paragraph -->
	</div>
	<!-- /wp:group -->
